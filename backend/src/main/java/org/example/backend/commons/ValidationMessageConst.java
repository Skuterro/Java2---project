...
public class ValidationMessageConst {
    ...
    public static final String NO_RARITY = "Rarity is required and cannot be empty!";
    public static final String NO_DESCRIPTION = "Description is required and cannot be empty!";
}
